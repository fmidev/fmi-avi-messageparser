...
public class Metar19Test extends AbstractAviMessageTest<String, Metar> {
	...
	public String getMessage() {
		return
				"METAR EFHK 111111Z 15008G20KT 0700 R04R/M1500VP2000N R15/P1000VM3000U R22L/1200N R04L/1000VP1500U SN VV006 M08/M10 Q1023 " + "WM01/H14 99//9999 BECMG AT0927 CAVOK TEMPO FM1051=";
	}
	...
	public Identity[] getLexerTokenSequenceIdentity() {
		return new Identity[] {
                ...
                SEA_STATE, RUNWAY_STATE, FORECAST_CHANGE_INDICATOR, FORECAST_CHANGE_INDICATOR, CAVOK, FORECAST_CHANGE_INDICATOR, FORECAST_CHANGE_INDICATOR, END_TOKEN
		};
	}
